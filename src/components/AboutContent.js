  ...
  return (
    ...
    <>
      <div class="about-page-content">
        <h1>
          Nation Park Note APP : About Page
    </h1>
        ...
        <h2>The APP allows the user to create his/her own account; Once an account is created, the user would be
        able to
      ...
      using the following criteria:<b>Park Name, Rating, State Name, Activity, Stop Number. </b>
        </h2>
      </div>
    </>
  )
